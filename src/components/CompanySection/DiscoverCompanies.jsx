                ...
                <div>
                    ...
                    <div>
                        {companies.map((company, index) => (
                            <CompanyCard
                                key={index}
                                onClick={() => { showDetail(company.name, company.logo) }}>
                                <img src={company.logo} alt={company.name} />
                                <div>
                                    <div>
                                        <h3>{company.name}</h3>
                                        <p style={{ color: "rgb(12,170,65)" }}>{company.rating}
                                            <FaStar color="rgb(12,170,65)" fontSize="12px" />
                                        </p>
                                    </div>
                                    <div>
                                ...
                                <p>{company.Jobs} Jobs . {company.Reviews} Reviews . {company.Salary} Salaries</p>
                                <div>
                                    <FaRegSmileBeam fontSize="20px" /> <p>{company.status}</p>
                                </div>
                            </CompanyCard>
                        ))}
                        <CompanyCard>
